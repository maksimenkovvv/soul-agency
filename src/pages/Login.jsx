...
function EyeIcon({ open }) {
  return open ? (
    ...
    // eye off
    <svg width="22" height="16" viewBox="0 0 22 16" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M8.2 3.2C9.1 2.8 10 2.6 11 2.6C13.9 2.6 16.4 4.4 18.2 8C17.6 9.2 16.9 10.2 16.1 11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M6.2 4.7C4.5 5.9 3.2 7.7 2.4 9.4C2.3 9.6 2.3 9.8 2.4 10C4 13.3 7.1 15.2 11 15.2C12.3 15.2 13.5 15 14.6 14.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M9.1 6.7C8.6 7.2 8.3 7.9 8.3 8.6C8.3 10.2 9.6 11.5 11.2 11.5C11.9 11.5 12.6 11.2 13.1 10.7" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M1.2 1.2L20.8 14.8" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
        ...
        <form onSubmit={handleSubmit}>
          {isCodeMode || isRegistrationCodeMode ? (
            ...
            <>
              <div className="login__form-group">
                ...
                <div style={fieldWrapStyle(focus.newPassword)}>
                  ...
                  />
                  <button type="button" aria-label={showNewPassword ? 'Скрыть пароль' : 'Показать пароль'} onClick={() => setShowNewPassword((v) => !v)} disabled={isLoading} style={eyeButtonStyle(showNewPassword, focus.newPassword)}>
              ...
              <div className="login__form-group">
                ...
                <div style={fieldWrapStyle(focus.confirmPassword)}>
                  <input
                    ...
                    style={{ border: 'none', outline: 'none', width: '100%', background: 'transparent' }}
                  />
                  <button type="button" aria-label={showConfirmPassword ? 'Скрыть пароль' : 'Показать пароль'} onClick={() => setShowConfirmPassword((v) => !v)} disabled={isLoading} style={eyeButtonStyle(showConfirmPassword, focus.confirmPassword)}>
            ...
            <>
              <div className="login__form-group">
                ...
                <input type="email" name="email" className="login__input" value={formData.email} onChange={handleChange} required disabled={isLoading} />
              </div>

              {!isRecoveryMode && !isLoginMode && (
                <div className="login__form-group">
                  <label className="login__label">Имя Фамилия</label>
                  <input type="text" name="fullName" className="login__input" value={formData.fullName} onChange={handleChange} required disabled={isLoading} />
                </div>
              )}
                ...
                <div className="login__form-group">
                  ...
                  <div style={fieldWrapStyle(focus.password)}>
                    <input
                      ...
                      style={{ border: 'none', outline: 'none', width: '100%', background: 'transparent' }}
                    />
                    <button type="button" aria-label={showPassword ? 'Скрыть пароль' : 'Показать пароль'} onClick={() => setShowPassword((v) => !v)} disabled={isLoading} style={eyeButtonStyle(showPassword, focus.password)}>
              ...
              {!isLoginMode && !isRecoveryMode && (
                <div className="login__policy">
                  <label className="login__policy-label label">
                    ...
                    <span className="label__text">Я ознакомлен(а) и принимаю условия Пользовательского соглашения и даю согласие на обработку персональных данных в соответствии с Политикой конфиденциальности.</span>
                  </label>
          ...
          <div className="login__group">
            {(isCodeMode || isRegistrationCodeMode || isPasswordChangeMode) && (
              <button type="button" className="login__group-btn login__button b-btn b-btn--transparent" onClick={goBack} disabled={isLoading}>
                Назад
              </button>
            )}

            <button type="submit" className="login__group-btn login__button b-btn" disabled={isLoading || (inCodeStep && isLocked)}>
