...
function OurPsychologists({ showTitle = true, psychologistsLenght = null }) {
    const psychologists = [
        {
            id: 1,
            name: "Иванна Иванова",
    ...
    const displayedPsychologists = psychologistsLenght ? psychologists.slice(0, psychologistsLenght) : psychologists;
        ...
        <div className="psychologists">
            ...
            <div className="psychologists__item-wrapper">
                {displayedPsychologists.map((psychologist) => (
                    <div key={psychologist.id} className="psychologists__item">
                        ...
                        <div className="psychologists__item-content">
                            ...
                            <p className="psychologists__item-content__experience"><span>Опыт:</span> {psychologist.experience}</p>
                            <p className="psychologists__item-content__price">{psychologist.price}</p>
                        </div>
                    </div>
                ))}
            </div>
