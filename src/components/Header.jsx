...
function Header() {
  ...
  return (
    <header
      className={`header ${menuOpen ? 'header--open' : ''}`}
      ref={wrapRef}
    >
      <Link
        to="/"
      ...
      <div className="header__right">
        ...
        {booting ? null : !isAuthenticated ? (
          <Link
            to="/login"
            className="header__login header__login--desktop"
          >
            Войти
            <svg
              width="24"
            ...
            >
              ...
              >
                {avatarUrl ? (
                  ...
                  <span className="header__avatarText">{getInitials(me)}</span>
                )}
              </span>
        ...
        <div className="header__drawerInner">
          <div className="header__drawerTop">
            {booting ? null : isAuthenticated ? (
              ...
              >
                <span
                  className="header__drawerAvatar"
                  aria-hidden="true"
                >
                  {avatarUrl ? (
                    <img
          ...
          <div className="header__drawerFooter">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="b-btn header__drawerCta"
              onClick={closeMenu}
            >
              Для психологов
            </a>
