...
const MethodFilter = ({ onApply, value }) => {
    ...
    React.useEffect(() => {
        const onDown = (e) => {
            ...
            if (!filterRef.current.contains(e.target)) setIsOpen(false);
        };
        const onKey = (e) => {
          ...
          {hasSelected ? `Метод: ${selectedOptions.length}` : "Метод"}
            ...
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              />
                    ...
                    <span className="filter-header-marker" aria-hidden="true">
              ...
              <span className="clear-mark" aria-hidden="true">
                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  />
                        ...
                        <button type="button" className="b-btn apply-button" onClick={handleApply}>
                            Применить
                        </button>
                    </div>
                ) : null}
